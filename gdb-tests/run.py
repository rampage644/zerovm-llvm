...
Channel = {ABS_PATH}/stdout.{NAME}, /dev/stdout, 0, 0, 0, 0, 99999999, 99999999
Channel = {ABS_PATH}/stderr.{NAME}, /dev/stderr, 0, 0, 0, 0, 99999999, 99999999
Channel = {ABS_PATH}/nvram.{NAME}.conf, /dev/nvram, 0, 0, 99999999, 99999999, 0, 0
